...
public class AppTest {
	...
	public void testeEmail() throws Exception {
		...
		stringBuilderTextoEmail.append(
				"<a target=\"_blank\" href=\"https://www.google.com\" style=\"color=#2525a7; padding=14px 25px; text-align:center; text-decoration: none; display:inline-block; border-radius:30px; font-size:20px; font-family:Arial; border:3px solid green; background-color: #99DA39;\">Acesso</a><br/><br/>");

		stringBuilderTextoEmail.append(
				"<span style=\"font-size=8px;\">Ass.: Ronaldo Costa, Desenvolvedor de software em JAVA.</span><br/>");

		stringBuilderTextoEmail.append("<b>Login:</b> juca@teste.com<br/>");
		stringBuilderTextoEmail.append("<b>Senha:</b> 248898<br/><br/>");
		 ...
		 * OU NAO
		 */
		enviaEmail.enviarEmailPDF(true);
	}
